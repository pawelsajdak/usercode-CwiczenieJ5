...
histo.SetAxisRange(5.e-13,8.e-12, "X")
...
l.SetTextSize(0.035)
#l.SetTextAlign(31)
l.DrawLatex(59.e-13,20.e3,"#cbarM_{#mu#mu} - m_{J/#psi}#cbar < 0.02 GeV")
l.DrawLatex(595.e-14,18.e3,"#DeltaR(p_{J/#psi})_{ track,rec} < 0.15")

canvas.Print(histname+"_lin"+"_finePlot.pdf")
